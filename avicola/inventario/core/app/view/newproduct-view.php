...
<div class="row">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <option value="">--SERVICIO--</option></select>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <option value="">--KILOGRAMOS--</option></select>
    </div>
  </div>
 ...
 <!--  <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Precio unitario referencial*</label>
    <div class="col-md-6">
      <input type="text" name="price_out" required class="form-control" id="price_out" placeholder="Precio de salida">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Tarifa IVA*</label>
    <div class="col-md-6">
    <select name="category_id" class="form-control" required>
